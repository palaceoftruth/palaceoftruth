...
{{- if .Values.image.tag -}}
{{- if and (eq .Values.image.workerRepository "palaceoftruth/palaceoftruth/backend-worker") (ne .Values.image.backendRepository "palaceoftruth/palaceoftruth/backend") -}}
