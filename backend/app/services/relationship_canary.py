...
def _operation_payload(
    ...
    *,
    ...
    return {
        ...
        "upstream_provider": getattr(result, "upstream_provider", "unknown"),
        "requested_model": getattr(result, "requested_model", "unknown"),
        "model": getattr(result, "model", "unknown"),
        "retry_provider": result.retry_provider,
        "fallback_used": result.fallback_used,
        "retry_count": result.retry_count,
        "prompt_version": getattr(result, "prompt_version", "unknown"),
        "temperature": getattr(result, "temperature", None),
        "seed": getattr(result, "seed", None),
        "persistence_min_confidence": getattr(result, "persistence_min_confidence", None),
        "persistence_threshold_rejected": getattr(
            result,
